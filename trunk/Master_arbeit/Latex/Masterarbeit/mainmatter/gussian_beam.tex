...
\end{figure}
%Spot Size
One of important characters is \bf{Spot Size}.In a cross-section of a gaussian beam the beam intesity is approximately distibuted as gaussian function. The spot size is the diameter of a area at whose edge the value of the electrical field intensity decay to $1/e$ of its peak value, otherwise the energy density to $1/e^2$ of the peak value. 
