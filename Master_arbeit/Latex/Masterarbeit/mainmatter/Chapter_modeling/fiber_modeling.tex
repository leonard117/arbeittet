...
\flushleft
	...
	\includegraphics[width=0.38 \textwidth]{bilder/surf_spot_1um}
	\label{fig:3d_spot_sub1}%
	}
 	\subfigure[3D Beam Power at distance $2\mu m$]{
 	\includegraphics[width=0.38 \textwidth]{bilder/surf_spot_2um}
...
%\flushleft
 	...
 	\includegraphics[width=0.38 \textwidth]{bilder/surf_spot_3um}
 	\label{fig:3d_spot_sub3}
 	}
 	\subfigure[3D Beam Power at distance $4\mu m$]{
 	\includegraphics[width=0.38 \textwidth]{bilder/surf_spot_4um}
...
%\flushleft
 	...
 	\includegraphics[width=0.38 \textwidth]{bilder/surf_spot_5um}
 	\label{fig:3d_spot_sub5}
 	}
 	 	\subfigure[3D Beam Power at distance $6\mu m$]{
 	\includegraphics[width=0.38 \textwidth]{bilder/surf_spot_6um}
